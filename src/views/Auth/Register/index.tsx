            ...
            <div className="relative w-full h-[100vh]">
                ...
                <div className="relative flex items-center justify-evenly w-full h-full px-4">
                    ...
                    <div className="bg-white p-10 rounded-xl w-[90%] max-w-md">
                        <h2 className="text-[#898121] text-3xl font-semibold mb-10">Buat Akun</h2>
                        ...
                        <form>
                            ...
                            <button onClick={handlerRegister} type="submit" className="w-full bg-[#898121] text-white py-3 rounded-lg font-semibold hover:bg-[#6F691A]">
                                Buat Akun
                            </button>
                        </form>

                        <div className="text-center mt-6">
                            <Link href="/auth/login" className="text-sm text-[#6B8F71] hover:text-[#577F5B]">Sudah punya akun? <span className="text-[#898121] font-semibold">Masuk</span></Link>
                        </div>
                    </div>
                </div>
            </div>
